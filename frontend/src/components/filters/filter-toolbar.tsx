...
export default function FilterToolbar({ onFiltersChange, isLoading, initialStatus }: FilterToolbarProps) {
  ...
  }, [search, status, hasLinkedin, hasGithub]);
  ...
  return (
    <div className="w-full rounded-2xl border border-slate-100 bg-white p-4 shadow-md shadow-slate-100/50 mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between animate-in fade-in duration-200">
